...
namespace EduEngine
{
	ParticleSystemD3D12::ParticleSystemD3D12(RenderDeviceD3D12* device, bool asyncCompute) :
		m_Device(device),
		...
		m_Timer(0)
	{
		m_ComputePass = std::make_unique<ParticlesComputePass>(m_Device, asyncCompute ? QueueID::Compute : QueueID::Direct);

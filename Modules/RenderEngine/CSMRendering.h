...
namespace EduEngine
{
	...
	{
	public:
		CSMRendering(RenderDeviceD3D12* device, float shadowDistance, int count, const XMFLOAT2* sizes, const float* cascadeSplits);
		...
		float GetCascadeDistance(int index) const { return m_CascadeSplits[index] * m_ShadowDistance; }
